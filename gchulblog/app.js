...
app.use(session({
    secret: settings.cookieSecret,//secret 对cookie加密，用来防止篡改 cookie
    key: settings.db,//key 的值为 cookie 的中保存的键值名字
    cookie: {maxAge: 1000 * 60 * 60 * 24 * 30},//设定 cookie 的有效时间，这里我们设置 cookie 的生存期为 30 天
    resave:true,
...
app.use(function(req,res,next){
    ...
    //是将session中保存的flash信息复制到response对象的locals属性中，这样才能在模板上显示这些信息
